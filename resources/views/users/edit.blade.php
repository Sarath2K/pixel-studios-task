        ...
        <section class="section">
            <div class="card">
                <div class="card-body p-2">
                    ...
                    <form method="post" action="{{route('users.update',['user' => $user->id])}}" method="PUT"
                          class="p-4">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-sm-4">
                                <select class="form-select states" aria-label="Default select example" id="role"
                                    ...
                                    @forelse($roles as $role)
                                        <option
                                            value="{{ $role->id }}" {{ $role->id == $user->roles[0]['id'] ? 'selected' : '' }}>
                                            {{ $role->name }}
                                        </option>
                                    @empty
                                ...
                                <fieldset class="mb-3 d-flex justify-content-around">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status_active"
                                               value="{{ EMPLOYEE_STATUS_ACTIVE }}" {{ $user->status === EMPLOYEE_STATUS_ACTIVE ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status_inactive"
                                               value="{{ EMPLOYEE_STATUS_INACTIVE }}" {{ $user->status === EMPLOYEE_STATUS_INACTIVE ? 'checked' : '' }}>
